  ...
  return (
    <>
      ...
      >
        <p
          className={` ${
            activeContent === "overview" ? "text-select mars" : ""
          }`}
        ...
        <p
          ...
          className={` ${
            activeContent === "structure" ? "text-select mars" : ""
          }`}
        >
          structure
        </p>
        <p
          ...
          className={` ${
            activeContent === "geology" ? "text-select mars" : ""
          }`}
        >
          surface
        </p>
      ...
      <div className="flex flex-col gap-4 items-center justify-center h-screen">
        <section className="text-white flex flex-col items-center lg:flex-row justify-center text-start md:gap-20">
          <div className="relative">
            <img
              src={
                activeContent === "overview"
                  ? jsonData[3].images.planet
                  : activeContent === "structure"
                  ? jsonData[3].images.internal
                  : jsonData[3].images.planet
              }
              alt=""
            ...
            <img
              src={
                activeContent === "geology" ? jsonData[3].images.geology : ""
              }
              className={
                activeContent === "overview"
                  ...
                  : "w-28 h-36 md:w-40 md:h-48 absolute left-8 top-20 bottom-0 md:left-28 md:bottom-16 md:top-52"
              }
              alt=""
            />
          </div>
          <div className="flex items-center flex-col md:flex-row justify-between w-[80vw] lg:w-auto lg:block">
            <div>
              ...
              <p className="w-96 lg:w-64 font-spartan text-sm font-normal my-5 text-center md:text-start">
                {jsonData[3][activeContent].content}
              </p>
              <p className="text-sm font-spartan flex items-center gap-2">
                Source:
                <Link
                  to={jsonData[3][activeContent].source}
                  target="blank"
                  className="underline"
                >
                  Wikipedia
            ...
            <div className="hidden md:flex flex-col text-start items-start my-5 font-spartan text-xs font-bold">
              <button
                className={`w-64 border-[1px] px-10 py-2 my-2 flex gap-4 uppercase ${
                  activeContent === "overview" ? "bg-[#d14c32] border-none" : ""
                }`}
                onClick={() => handleContentChange("overview")}
              >
                <span>01</span>
              ...
              <button
                className={`w-64 border-[1px] px-10 py-2 my-2 flex gap-4 uppercase ${
                  activeContent === "geology" ? "bg-[#d14c32] border-none" : ""
                }`}
                onClick={() => handleContentChange("geology")}
              >
                <span>03</span>
